...
function sidebar() {
  return (
    <div  className="flex flex-col  gap-y-6 w-45 pt-3 h-full  bg-[#F4F4F4]">
       ...
       <Link to="/subcategory"className="flex items-center gap-x-9 justify-between"> <span className="flex items-center gap-x-3">  <CiCircleList className="text-2xl"/> Subcategory </span><BiSolidRightArrow/> </Link>
       <Link to="/" className="flex items-center gap-x-9 justify-between">  <span className="flex items-center gap-x-3"> <BsBox className="text-2xl"/> Group </span> <BiSolidRightArrow/> </Link> 
    </div>
  )
}
